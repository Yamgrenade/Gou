    ...
    while not libtcod.console_is_window_closed():
        ...
        if move and game_state == GameStates.PLAYERS_TURN:
            ...
            for entity in entities:
                ...
                message_log.add_message(Message('You fumble around on the ground but find nothing.', libtcod.yellow))
        ...
        for player_turn_result in player_turn_results:
            ...
            if xp:
                ...
                if leveled_up:
                    message_log.add_message(Message('You have honed your skills to reach level {0}.'.format(
                        player.level.current_level), libtcod.cyan))
                    previous_game_state = game_state
            ...
            if targeting:
                ...
                message_log.add_message(targeting_item.usable.targeting_message)
...
def main():
    ...
    libtcod.console_set_custom_font('symbols.png', libtcod.FONT_TYPE_GREYSCALE | libtcod.FONT_LAYOUT_TCOD)
